...
pipeline{
    ...
    environment{
        VERSION = '1.3'
        SERVER_CREDENTIALS = credentials('scope-project')
    ...
    stages{
        ...
        stage("deploy"){
            steps{
                ...
                withCredentials([
                    usernamePassword(credentials:'scope-project',usernameVariable:'USER',passwordVariable:'PASSWORD') //Using the usernamePassword function because the type of credentials we created on jenkins was of this type.. 
