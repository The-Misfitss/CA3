    ...
    stages{
        ...
        stage("deploy"){
            steps{
                ...
                withCredentials([
                    usernamePassword(credentials:'server-credentials',usernameVariable:USER,passwordVariable:PASSWORD) //Using the usernamePassword function because the type of credentials we created on jenkins was of this type.. 
